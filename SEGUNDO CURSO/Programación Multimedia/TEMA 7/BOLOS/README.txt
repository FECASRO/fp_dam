...
This is the readme for BOLOS, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. BOLOS) > Ok.
...
- To run the project find BOLOS.java (which will be in under src/main/java/bolos) and right click > Run 'BOLOS'
