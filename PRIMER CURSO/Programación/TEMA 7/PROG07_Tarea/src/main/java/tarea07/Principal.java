 ...
 * @author FELIPE
 * @version 1.0 
 * Esta es la clase pricipal, aqui Contendrá el método main y todo el código 
 * de interacción con el usuario (lectura de teclado y salida por pantalla).
 */
public class Principal {

    public static void main(String[] args) {
/**Aqui definimos variables*/
...
// Aqui el bucle que pinta el menu.
        while (!salir) {
            ...
            try {
                ...
                opcion = sn.nextInt();
//Aqui menu se piden datos y se pinta otro menu mas.
                switch (opcion) {
                    case 1:
...
//Aqui el menu de tipo de cuentas
                        switch (tipoCuenta) {
                            case 1:
